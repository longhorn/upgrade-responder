...
| `--scarf-endpoint` | `https://your.gateway.scarf.sh/packageroute/{version}` | Specify the Scarf.sh endpoint URL template. Use {version} placeholder for app version substitution. Default value is empty which means scarf is not being used                                                                    |
